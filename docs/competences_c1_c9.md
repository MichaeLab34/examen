...
| C9 — Amélioration continue | Fort+ | Notebook §13, `monitoring.py`, `docs/monitoring_plan.md`, persistance drift | PSI, seuils watch/alert, revue labels, champion/challenger, ré-entraînement |
...
- Médaillon : Bronze brut restreint, Silver nettoyé/pseudonymisé, Gold ML-ready.
...
**Attendus de l'énoncé** : MLOps, drift, ré-entraînement, revue des indicateurs, versioning.
...
5. Industrialisation raisonnable : bundle + CLI/API + médaillon + monitoring.
